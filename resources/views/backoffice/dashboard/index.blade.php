          ...
          <div class="app-brand demo">
            <a href="{{ route('backoffice.dashboard') }}" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img src="{{$textos['logo']}}" alt="" width="32">
              </span>
              <span class="app-brand-text demo menu-text fw-bold ms-3">{{ $textos['nombre'] }}</span>
            </a>
                    ...
                    <li>
                      <div class="d-grid px-2 pt-2 pb-1">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="btn btn-sm btn-danger d-flex form-control">
